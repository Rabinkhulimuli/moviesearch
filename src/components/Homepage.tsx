      ...
      <div className="">
        <div className="relative">
          ...
          <div className="top-0 z-10 h-160 md:h-170 max-h-screen relative inset-0 bg-black/50 capitalize  flex flex-col items-center justify-center gap-4">
            <p className="text-2xl md:text-[4rem] font-semibold">Search movies</p>
             <div  className="focus:ring-2 focus:ring-amber-200">
                  <form onSubmit={handleSearch} className="flex text-lg bg-gray-700 border w-fit gap-4 items-center rounded-md px-2 py-1">
                    <input
